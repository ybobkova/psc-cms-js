define(['Psc/InvalidArgumentException','Psc/Code'], function() {
  Joose.Class('Psc.EventManager', {
    
    has: {
      logging: { is : 'rw', required: false, isPrivate: true, init: false },
      jq: { is: 'r', required: false, handles: [ 'bind', 'on', 'one', 'off', 'trigger' ] } // one wird in matrix-manager von tiptoi bentutz
    },
