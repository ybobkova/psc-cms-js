...
Joose.Role('Psc.CMS.Buttonable', {
  ...
  use: ['Psc.Code', 'Psc.CMS.TabOpenable'],
  ...
  methods: {
    ...
    initClickable: function () {
      if (Psc.Code.isJoose.Role(this, Psc.CMS.TabOpenable)) {
        this.unwrap().addJoose.Class('psc-cms-ui-tab-button-openable'); // weiter gehts in main on click
      }
    },
