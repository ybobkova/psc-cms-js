define(['joose', 'ace/ace', 'ace/mode/javascript', 'ace/mode/tito', 'ace/theme/crimson_editor', 'ace/theme/vibrant_ink', 'Psc/UI/WidgetWrapper'], function(Joose, ace, aceJavascript, aceTito) {
  /**
