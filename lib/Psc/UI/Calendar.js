define(['joose', 'jquery', 'Psc/Date', 'Psc/EventDispatching', 'Psc/UI/WidgetWrapper', 'Psc/CalendarCalculation',
        'Psc/UI/TableBuilder', 'Psc/UI/Table', 'jquery-ui', 'jquery-ui-i18n'], function (Joose, $) {
  ...
  Joose.Class('Psc.UI.Calendar', {
    ...
    methods: {
      initUI: function () {
        if (!this.$$displayDate) {
          this.setDisplayDate(new Psc.Date());
        }
