            ...
            if (!ev.isDefaultPrevented()) {
              ...
              items.push(
                ui.createTabButtonItem(
                  ...
                  ui.button('Seiteninformationen bearbeiten', 1)
                )
              );
              ...
              for(var language, i=0; i<node.languages.length; i++) {
                ...
                items.push(
                  ui.createTabButtonItem(
                    ui.tab('page', node.pageId, ['contentstream', language], 'Seiteninhalt von '+node.label+' für '+language.toUpperCase()),
                    ui.button('Seiteninhalte für '+language.toUpperCase()+' bearbeiten', 1)
                  )
                );
              }
