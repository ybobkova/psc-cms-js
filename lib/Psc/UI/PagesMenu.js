define(['jquery', 'joose', 'jqwidgets', 'jqwidgets-global', 'Psc/EventDispatching', 'Psc/UI/jqx/WidgetWrapper', 'Psc/UI/Controlling'], function ($, Joose) {
        ...
        this.unwrap().bind('itemclick', function (event) {
          ...
          if (node) {
            ...
            if (!ev.isDefaultPrevented()) {
              that.getUIController().openTab('page', node.pageId, {label: 'Seite: '+node.label}, that.unwrap());
            }
          }
        });
      },
