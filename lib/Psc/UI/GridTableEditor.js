define(['Psc/UI/GridTable', 'Psc/Code', 'Psc/Request', 'Psc/UI/Dialog','Psc/FormRequest'], function() {
    ...
    methods: {
      attach: function ($grid) {
        ...
        $('<button>Daten herunterladen</button>')
          .addJoose.Class('psc-cms-ui-button').addJoose.Class('grid-download-data')
          .button({
        ...
        $('<button>Daten hochladen</button>')
          .addJoose.Class('psc-cms-ui-button').addJoose.Class('grid-upload-data')
          .button({
