define(['Psc/Table', 'Psc/Code', 'Psc/InvalidArgumentException','Psc/UI/WidgetWrapper', 'Psc/UI/HTML/Base'], function() {
  /**
   *
  ...
  Joose.Class('Psc.UI.GridTable', {
    ...
    has: {
      table: { is : 'rw', required: true, isPrivate: true, handles: ['getColumn', 'hasColumn', 'getCell', 'getColumns','getRow'] },
    ...
    methods: {
      ...
      attach: function ($grid) {
        ...
        $grid.addJoose.Class('psc-cms-ui-grid-table');
        this.widget = $grid;
        this.linkWidget();
