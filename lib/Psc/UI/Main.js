  ...
  Joose.Class('Psc.UI.Main', {
    ...
    methods: {
      ...
      preview: function ($form, tabHook, $target, additionalData) {
        ...
        Psc.UI.FormController.changeRevision('preview-'+(new Date()).getTime(), $form); // use some unique preview identifier because of concurrency
        
        return this.save($form, tabHook, additionalData);
      },
