/*globals alert:true*/
define(['Psc/UI/WidgetWrapper', 'Psc/UI/EffectsManager','Psc/AjaxHandler','Psc/Request','Psc/Exception','Psc/Code', 'Psc/ResponseMetaReader', 'Psc/EventDispatching'], function() {
	/**
