define(['Psc/UI/ResizableImage','Psc/Request', 'Psc/UI/WidgetWrapper', 'Psc/EventDispatching'], function() {
  /**
   *
   * Events:
  ...
  Joose.Class('Psc.UI.UploadableImage', {
    ...
    methods: {
      ...
      _createImage: function () {
        ...
        var $widget =
              $('<div class="psc-cms-ui-uploadable-image" title="Doppelklick zum Bearbeiten" />')
                ...
                .append($('<img src="'+this.$$url+'?nocache='+(new Date()).getTime()+'" alt="" title="Doppelklick zum Bearbeiten" />').css('max-width','300px'))
      ...
      _createPlaceholder: function () {
        ...
        $widget.css('height', '120px').css('width','120px').css('border','1px solid black');
