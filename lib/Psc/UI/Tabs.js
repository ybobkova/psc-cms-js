...
define(['Psc/UI/Tab', 'Psc/UI/WidgetWrapper', 'Psc/EventDispatching', 'Psc/Code', 'Psc/InvalidArgumentException', 'Psc/UI/TabNotFoundException', 'Psc/Exception', 'Psc/UI/ContextMenuManager', 'Psc/UI/ErrorPane'], function() {
  /**
   * Events:
   *   - remote-tab-load kurz vor remote-tab-loaded
  ...
  Joose.Class('Psc.UI.Tabs', {
    ...
    methods: {
        ...
        this.widget = $tabs.tabs({
          ...
          ajaxOptions: {
            ...
            success: function(xhr, status) {
              that.handleAjaxSuccess(xhr, status);
            },
      ...
      handleAjaxSuccess: function (xhr, status, index, anchor) {
        this.getEventManager().triggerEvent('remote-tab-loaded', {source: 'tabs', status:'success'}, [xhr]);
      },
      handleAjaxError: function (xhr, status, index, anchor) {
        var $tab = this.widget.find(anchor.hash);
        this.getEventManager().triggerEvent('remote-tab-loaded', {source: 'tabs', status:'error'}, [xhr]);
