...
define(['jquery', 'JSON', 'jquery-ui','Psc/UI/Tab', 'Psc/UI/WidgetWrapper', 'Psc/EventDispatching', 'Psc/Code', 'Psc/InvalidArgumentException', 'Psc/UI/TabNotFoundException', 'Psc/Exception', 'Psc/UI/ContextMenuManager', 'Psc/UI/ErrorPane'], function() {
  /**
   * Events:
  ...
  Joose.Class('Psc.UI.Tabs', {
    ...
    methods: {
      ...
      initWidget: function($tabs) {
        ...
        var pinnedTabs = this.getPinnedTabs(), pinnedTab, lastTab;
