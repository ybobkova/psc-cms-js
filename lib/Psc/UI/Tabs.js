...
define(['joose', 'jquery', 'JSON', 'jquery-ui','Psc/UI/Tab', 'Psc/UI/WidgetWrapper', 'Psc/EventDispatching', 'Psc/Code', 'Psc/InvalidArgumentException', 'Psc/UI/TabNotFoundException', 'Psc/Exception', 'Psc/UI/ContextMenuManager', 'Psc/UI/ErrorPane', 'Psc/ContainerDepending'], function(Joose) {
  /**
   * Events:
