define(['joose', 'Psc/UI/GridTable', 'Psc/TableModel', 'Psc/Numbers', 'Psc/UI/Dialog', 'Psc/UI/WidgetWrapper'], function(Joose) {
  /**
   * A GridTable tied to a upload-manager directory
   *
   * 
   */
