define(['Psc/GuidManager', 'Psc/UI/NavigationNode', 'Psc/Code','Psc/UI/Button', 'Psc/UI/WidgetWrapper'], function() {
  Joose.Class('Psc.UI.Navigation', {
    ...
    methods: {
      ...
      visitChildren: function(u, depth) {
        var i, v;
