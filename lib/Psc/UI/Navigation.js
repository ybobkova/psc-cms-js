...
define(['joose', 'jqwidgets', 'Psc/GuidManager', 'Psc/UI/NavigationNode', 'Psc/Code', 'Psc/UI/Button', 'Psc/UI/WidgetWrapper', 'Psc/UI/Controlling', 'Psc/UI/Translating'], function(Joose) {
    ...
    methods: {
      ...
      initHandlers: function() {
        ...
        $widget.on('click', 'button.open-page', function (e) {
          ...
          that.getUIController().openTab('page', node.getPageId(), {label: that.trans('Seite für Navigations-Punkt: '+node.getTitle()});
        });
