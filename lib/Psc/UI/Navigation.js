  ...
  Joose.Class('Psc.UI.Navigation', {
    ...
    methods: {
      ...
      initHandlers: function() {
        ...
        this.getNavigationWidget().append($bottomButton);
        this.getNavigationWidget().prepend($topButton);

        $bottomButton.on('click', function(e) {
          e.stopPropagation();
          e.preventDefault();
          that.add($.extend(true, {}, that.getDefaultNode()), 'bottom');
        });

        $topButton.on('click', function(e) {
          e.stopPropagation();
          e.preventDefault();
          that.add($.extend(true, {}, that.getDefaultNode()), 'top');
        });
