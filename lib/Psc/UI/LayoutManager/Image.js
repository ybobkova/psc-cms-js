define(['joose', 'Psc/UI/SplitPane', 'Psc/UI/UploadableImage', 'Psc/UI/Group', 'Psc/UI/LayoutManagerComponent'], function(Joose) {
  Joose.Class('Psc.UI.LayoutManager.Image', {
    ...
    has: {
      ...
      resize: { is : 'rw', required: false, isPrivate: true, init: Joose.I.Object }, // a hash with width and height or both how the maximum values should be for the inline image
    },
