define(['lodash', 'Psc/UI/SplitPane', 'Psc/UI/Button', 'Psc/UI/UploadableFile', 'Psc/Numbers', 'Psc/UI/Group', 'Psc/UI/GridTable', 'Psc/UI/Table', 'Psc/UI/LayoutManagerComponent'], function(_) {
  /**
   * Events:
  ...
  Joose.Class('Psc.UI.LayoutManager.Downloadslist', {
    ...
    methods: {
      ...
      _appendSelectDownload: function () {
        var that = this;
        this.$$files.append($li);
      },
          ...
          onCreate: function (e, dialog) {
            ...
            $.when(that.getUploadService().pullUploadFiles()).then(function(files) {
              ...
              $grid.on('click', 'button.select', function (e) {
                ...
                var file = $(e.target).data('select-file');
