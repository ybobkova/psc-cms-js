Joose.Class('Psc.UI.FormController', {
  ...
  use: ['Psc.EventManager', 'Psc.AjaxFormHandler', 'Psc.FormRequest','Psc.ResponseMetaReader','Psc.UI.EffectsManager',
        'Psc.Code', 'Psc.Response',
        'Psc.UI.WidgetWrapper', 'Psc.UI.GridTable', 'Psc.UI.ErrorPane'],
