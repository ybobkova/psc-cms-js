define([
  ...
  Joose.Class('Psc.UI.LayoutManager', {
    ...
    does: [Psc.UI.EffectsManaging, Psc.TextParser, Psc.ContainerDepending],
    ...
    methods: {
      initUI: function () {
        ...
        $layout.sortable({
          ...
          morphStop: function (e, $widget) {
            if ($widget.hasClass('contentstreamwidget')) {
        ...
        this.$$layout.on('click', 'div.contentstreamwidget', function (e) {
      ...
      initControls: function () {
        ...
        for (var i = 0, control; i<this.$$controls.length; i++) {
          ...
          $button.draggable({
            connectMorphSortable: '.active-content-stream-container div.content-stream:first',
      ...
      createUI: function () {
        ...
        for (var i = 0, control; i<this.$$controls.length; i++) {
          ...
          if (!sect[ctrlSection]) {
            ...
            sections.push({
              'label': sectionLabels[ctrlSection] || ctrlSection,
              'name': ctrlSection
            });
          }
        }
