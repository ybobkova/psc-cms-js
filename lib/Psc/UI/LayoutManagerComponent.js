define(['Psc/UI/WidgetWrapper', 'Psc/UI/EffectsManaging', 'Psc/UI/EffectsManaging', 'Psc/UI/FormBuilding'], function () {
  Joose.Class('Psc.UI.LayoutManagerComponent', {
    isa: Psc.UI.WidgetWrapper,
    
    does: [Psc.UI.EffectsManaging, Psc.UI.FormBuilding],
      ...
      create: function () {
        ...
        this.widget = $widget = 
          $('<div class="widget '+this.$$type+'"><h3 class="widget-header"></h3><div class="widget-content"></div></div>')
            .addJoose.Class('ui-widget ui-widget-content ui-helper-clearfix ui-corner-all')
