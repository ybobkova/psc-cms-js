  ...
  Joose.Class('Psc.UI.LayoutManagerComponent', {
    ...
    methods: {
      ...
      createKOTextarea: function (fieldName) {
        var html = '<textarea class="paragraph" data-bind="value: '+fieldName+'.value" name="disabled[layout-manager-component]" cols="120" rows="5" style="width: 100%; min-height: 120px"></textarea>';
        return html;
      },
      
      createKOTextfield: function(fieldName) {
        var html = '<input type="text" style="width: 100%" data-bind="value: '+fieldName+'.value" name="disabled[layout-manager-component]" />';
