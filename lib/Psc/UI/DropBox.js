/*globals alert:true*/
define(['jquery','jquery-ui','Psc/UI/DropBoxButton', 'Psc/UI/WidgetWrapper', 'Psc/EventDispatching', 'Psc/Code', 'Psc/InvalidArgumentException', 'Psc/Exception'], function() {
  Joose.Class('Psc.UI.DropBox', {
    ...
    methods: {
      ...
      addButton: function(button) {
        Psc.Code.assertRole(button, Psc.UI.DropBoxButton, 'button', 'DropBox.addButton()');
        ...
        if (this.addButtonHash(button, $button)) {
          ...
          // das sollten wir erst machen wenn der button initialisiert ist!
          // am besten mit einem hook des widgetsInitializers?
      ...
      addButtonHash: function (button, $button) {
        if (!Psc.Code.isRole(button, Psc.UI.DropBoxButton)) {
        ...
        $button.addClass('psc-cms-ui-button')
