    ...
    methods: {
      ...
      html: function () {
        if (!this.$$li) {
          ...
          $buttonPanel.append(this.htmlToggleButton());
      ...
      htmlToggleButton: function (open) {
        var button = new Psc.UI.Button({
          leftIcon: !open ? 'circlesmall-plus' : 'circlesmall-minus',
          label: 'sub'
        });

        return button.create().addClass('sub').attr('title','Klicken um die Unternavigations-Punkte ein oder auszublenden.');
      },
