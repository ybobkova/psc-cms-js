  ...
  Joose.Class('Psc.UI.NavigationNode', {
    ...
    methods: {
      ...
      htmlPageButton: function () {
        ...
        var $button = $(
            '<button class="open-page psc-cms-ui-button ui-button ui-widget ui-state-default ui-button-text-icons ui-corner-left" role="button" aria-disabled="false" title="Der Navigations-Punkt hat eine verknüpfte Seite.">'+
            '<span class="ui-button-icon-primary ui-icon ui-icon-script"></span>'+
            '<span class="ui-button-text">Seite</span>'+
