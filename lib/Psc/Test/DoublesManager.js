define(['joose', 'test-files/navigation.comun.flat', 'Psc/UploadService', 'Psc/Container', 'Psc/ContainerInjecting', 'Psc/UI/TestInteractionProvider'], function(Joose, flat) {
