define(['joose', 'test-files/navigation.comun.flat', 'translator', 'Psc/UploadService', 'Psc/Container', 'Psc/ContainerInjecting', 'Psc/UI/TestInteractionProvider'], function(Joose, flat, translator) {
  Joose.Class('Psc.Test.DoublesManager', {

    does: [Psc.ContainerInjecting],
    ...
    methods: {
      ...
      getNavigationService: function () {
        return this.getContainer().getNavigationService().setFlat(flat);
      },
