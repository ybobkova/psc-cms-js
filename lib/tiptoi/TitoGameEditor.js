define(['Psc/Table', 'Psc/EventDispatching', 'Psc/CMS/FastItem', 'Psc/UI/EffectsManaging', 'Psc/UI/Button', 'Psc/Numbers', 'Psc/UI/Dialog', 'Psc/UI/WidgetWrapper', 'Psc/AjaxResponseErrorHandler'], function() {
