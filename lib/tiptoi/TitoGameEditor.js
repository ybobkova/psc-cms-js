define(['Psc/Table', 'Psc/EventDispatching', 'Psc/UI/EffectsManaging', 'Psc/UI/Button', 'Psc/Numbers', 'Psc/UI/Dialog', 'Psc/UI/WidgetWrapper', 'Psc/AjaxResponseErrorHandler'], function() {
        ...
        $syncButton.on('click', function (e) {
          ...
          that.$$service.dispatch(
            that.$$service.createRequest(
              ['tito','synchronize'],
              'POST',
              {gameNum: that.getGameNum(), tito: that.$$tito},
              'json'
            )
            ...
            Psc.AjaxResponseErrorHandler.openDialog(response);
          });
        });
