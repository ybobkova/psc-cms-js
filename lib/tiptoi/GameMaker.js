define(['joose', 'tiptoi/GameSimulator', 'Psc/Code', 'Psc/Request', 'Psc/UI/WidgetWrapper', 'Psc/UI/EffectsManager', 'Psc/UI/EffectsManaging'], function(Joose) {
  Joose.Class('tiptoi.GameMaker', {
    ...
    has: {
      ...
      scale: { is: 'rw', required: true, isPrivate: true},
