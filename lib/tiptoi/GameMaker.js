Joose.Class('tiptoi.GameMaker', {
  ...
  use: ['tiptoi.GameSimulator', 'Psc.Code', 'Psc.Request', 'Psc.UI.WidgetWrapper', 'Psc.UI.EffectsManager'],
  ...
  methods: {
    ...
    createButton: function (name, oid) {
      ...
      if (!this.$$hasLayout) {
        $button
          .button({}) // wir machen einen button raus, der ist sichtbarer als das halb-trans kästchen
      }
