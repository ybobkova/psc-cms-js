  ...
  Joose.Class('tiptoi.ProgramRunner', {
    ...
    methods: {
      run: function (program) {
        ...
        /*
          Die Reihenfolge der Parameter im programScope ist wichtig für das aufrufen von sub-programmen (mit require)
        ...
        */
        var programScope = {
          ...
          playQuestionSound: function (sound) {
            soundPlayer.playSound(sound, 'question');
          },
          ...
          A: {
            ...
            shuffle: function(array) {
              if (!array.sort) {
                throw new Error('Das objekt hat keine Funktion .sort und ist deshalb kein Array. (Parameter von Shuffle)');
              }
              array.sort(function () {
          ...
          chooseRandom: function (array) {
            var index = Psc.Numbers.randomInt(0, array.lenght-1);
            return array[index];
          },
        ...
        setTimeout(function () {
          ...
          try {
            ...
            Psc.Code.warning('Fehler beim Ausführen von jSprogram', ex, printStackTrace({e: ex}));
