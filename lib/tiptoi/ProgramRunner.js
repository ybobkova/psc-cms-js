/*jshint evil:true*/
define(['joose', 'jquery', 'tiptoi/SimpleSoundPlayer','tiptoi/Program', 'tiptoi/cpu', 'tiptoi/GameTable', 'tiptoi/Sound', 'tiptoi/StringOutput',
        'Psc/InvalidArgumentException', 'Psc/Code'], function (Joose, $) {
