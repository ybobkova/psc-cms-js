/*globals alert:true*/
define(
  ['joose', 'jquery', 'tiptoi/StringOutput', 'tiptoi/HTMLOutput','tiptoi/ProgramRunner', 'tiptoi/SimpleSoundPlayer','tiptoi/InteractiveInputProvider',
  ...
  Joose.Class('tiptoi.GameSimulator', {
    ...
    methods: {
      ...
      reset: function () {
        ...
        if (this.$$runStatus && this.$$runStatus.reject) {
