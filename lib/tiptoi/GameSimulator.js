Joose.Class('tiptoi.GameSimulator', {
  ...
  use: ['tiptoi.StringOutput', 'tiptoi.HTMLOutput','tiptoi.ProgramRunner', 'tiptoi.SimpleSoundPlayer','tiptoi.InteractiveInputProvider',
        'Psc.EventManager', 'Psc.Code'
      ],
  ...
  methods: {
    ...
    reset: function () {
      ...
      if (this.runStatus) {
        runStatus.reject('reset von GameSimulator');
      }
    },
