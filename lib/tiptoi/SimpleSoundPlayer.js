define(['joose', 'jquery', 'Psc/Code', 'tiptoi/Sound', 'Psc/Numbers', 'Psc/EventDispatching'], function(Joose, $) {
  Joose.Class('tiptoi.SimpleSoundPlayer', {
    ...
    methods: {
      playSound: function (sound, type) {
        if (sound) {
          if (!type) type = 'normal';
          
          sound = this.normalizeSound(sound);
          this.$$eventManager.triggerEvent('play-sound', {}, [sound, type]);
