define(['joose', 'Psc/Code', 'tiptoi/SimpleSoundPlayer', 'tiptoi/ProgramRunner', 'tiptoi/Program', 'tiptoi/InputProvider', 'tiptoi/Sound', 'tiptoi/ConsoleOutput'], function(Joose) {
    ...
    methods: {
      run: function() {
        ...
        status.progress(function (cpu) {
          ...
          var output = new tiptoi.ConsoleOutput({eventManager: cpu.getEventManager(), silent: true});
        });
