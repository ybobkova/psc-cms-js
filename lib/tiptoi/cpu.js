define(['joose', 'tiptoi/Timer','Psc/EventDispatching','tiptoi/Sound'], function(Joose) {
  ...
  Joose.Class('tiptoi.cpu', {
    ...
    has: {
      ...
      startedTimers: { is: 'rw', required: true, isPrivate: true, init: Joose.I.Array }
    },
    ...
    methods: {
      ...
      startTimer: function(seconds) {
        ...
        this._trigger('start-timer', [timer]);
        timer.start();
        return timer;
      },
      ...
      createSound: function(props) {
        ...
        for (var i = 0, timer; i < this.$$startedTimers.length; i++) {
          timer = this.$$startedTimers[i];
          timer.stop();
        }
