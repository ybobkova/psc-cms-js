define(['joose', 'tiptoi/Timer','Psc/EventDispatching','tiptoi/Sound'], function(Joose) {
  ...
  Joose.Class('tiptoi.cpu', {
    ...
    has: {
      ...
      activatedTimers: { is: 'r', required: true, isPrivate: true, init: Joose.I.Array}
    },
    ...
    methods: {
      ...
      startTimer: function(seconds) {
        ...
        timer.start();
        this.$$activatedTimers.push(timer);
        return timer;
      },
      ...
      createSound: function(props) {
        ...
        for (var i = 0; i < this.$$activatedTimers.length; i++) {
          this.$$activatedTimers[i].stop();
        }
      },
