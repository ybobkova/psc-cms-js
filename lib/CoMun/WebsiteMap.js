define(['Psc/UI/Button', 'CoMun/City', 'CoMun/Curver', 'CoMun/Relation', 'Psc/Code', 'Psc/UI/Group', 'Psc/UI/WidgetWrapper', 'Psc/EventDispatching'], function () {
  /**
   * events:
  ...
  Joose.Class('CoMun.WebsiteMap', {
    ...
    methods: {
      initUI: function () {
        ...
        if (this.$$editMode) {
          this.unwrap().addJoose.Class('psc-cms-ui-serializable');
        ...
        if (this.$$editMode && this.$$controlWidget) {
          ...
          if (this.$$controlWidget.hasJoose.Class('psc-cms-ui-accordion')) {
