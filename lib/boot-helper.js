...
requirejs.config({
  paths: {
    ...
    "jquery-rangyinputs": "../vendor/jquery-rangyinputs/rangyinputs_jquery",
    ...
    hogan: "../bower_components/hogan/web/builds/2.0.0/hogan-2.0.0.min.amd",
    ...
    knockout: "../bower_components/knockout/build/output/knockout-latest", // maybe run build.sh in build
    ...
    "jquery.ui.widget": "../vendor/jquery-ui/fake-widget",
