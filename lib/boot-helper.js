...
requirejs.config({
  ...
  paths: {
    ...
    'i18next': '../vendor/i18next/i18next.amd-1.6.3.min'
  }
});

define(['jquery', 'joose', 'translator', 'jquery-ui', 'Psc/UI/Main', 'Psc/UI/Tabs', 'Psc/Loader', 'Psc/Code', 'jquery-global-de-DE'], function($, Joose, translator) {
