define(['psc-tests-assert', 'joose', 'jquery-simulate','Psc/UI/AutoComplete','Psc/EventManagerMock','Psc/AjaxHandler','Psc/AjaxResponse','Psc/Loader','Psc/UI/Tab'], function(t, Joose) {
  ...
  var setup = function(test) {
    ...
    var AjaxHandlerMockClass = Joose.Class({
      isa: Psc.AjaxHandler,
  ...
  test("manual searching", function() {
    ...
    var autoComplete = new Psc.UI.AutoComplete({
      ...
      autoComplete.search(' giraffe '); // tests, whether the string will be trimmed
      stop();
